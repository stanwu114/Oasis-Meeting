...
## 会议要点
- 逐条列出会上提到的具体事实、数据、观点和细节
- 每条就是一个独立的信息点,不是段落叙述
- 保留原始数字(如"增长12%""预算50万")、人名、日期、产品名等,原样照抄不要改写
- 语气接近现场速记:谁说了什么、数据是多少、提到了什么方案,直接记录
- 数量宁多勿少,重要的细节都列出来,不要合并压缩
- 例如:
  - 活跃用户 285 万,环比增长 12%
  - 张三:推荐算法 CTR 提升到 3.2%,超过预期
  - 下季度预算 500 万,其中 60% 投技术侧
  - 李囡提出竞品 X 上线了类似功能,用户反馈一般
